...
import com.eddzequiel.vets.domain.Client;
import com.eddzequiel.vets.repository.ClientRepository;
...
/**
 * REST controller for managing {@link com.eddzequiel.vets.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
